...
function Navbar () {
  ...
  return(
    <>
     <nav className="navbar navbar-expand-lg bg-dark fixed-top">
      <div className="container-fluid bg-dark p-1">
        <Link to="/" onClick={handleNavigation} className="navbar-brand text-light fw-bold"><img className="img-fluid rounded-circle" src="/images/logo.jpg" style={{width: "2.9rem"}} /></Link>
    ...
    <Outlet />
    <footer className='p-3 text-center footer mt-auto fw-bold text-white bg-dark'>Copyright Allserved <a className="link-underline link-underline-opacity-0 text-light" href="https://www.facebook.com/profile.php?id=61552058284454&sk=photos"><img className="img-fluid" src="/images/fbicon.webp" style={{width: "2rem"}} />Campgyup</a> 2025</footer>
    </>
  )
}
